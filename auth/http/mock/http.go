...
//
//	mockgen -source auth/http/http.go -package mock_http -destination auth/http/mock/http.go
//
...
func (m *MockHTTPRequest) SetError(error any) http.HTTPRequest {
	m.ctrl.T.Helper()
...
func (m *MockHTTPRequest) SetResult(result any) http.HTTPRequest {
	m.ctrl.T.Helper()
